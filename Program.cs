...
namespace Tvzon
{
	class Program
	{
		...
		//		const string url = "http://xmltv.tvtab.la/xmltv/channels.xml.gz";
		//		const string ApiChannelsUrl = "http://api.tvtab.la/channels.xml";
		//		const string ChannelsLastModifiedUrl = "http://xmltv.tvtab.la/xmltv/datalist.xml.gz";

                const string url = "http://xmltv.xmltv.se/channels.xml.gz";
                const string ApiChannelsUrl = "http://api.epg.io/2/channel/list/";
